...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
        ...
        insertData("Thermo T-shirt","Thermoactive t-shirt perfect for the gym", BigDecimal.valueOf(34.99),createProductFeatures("purple","100% cotton",Gender.MALE,BigDecimal.valueOf(80)),createProductCategory("T-shirts"),"static/images/burst.shopify.com/tshirt2.jpg");
